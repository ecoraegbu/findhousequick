<section class="px-8 pb-8">
  ...
  <div class="p-4 bg-white rounded-xl">
    ...
    <h1 class="text-gray-700 font-bold text-xl">Update Profile Picture</h1>
    ...
    <div class="flex flex-wrap flex-col md:flex-row gap-4">
      ...
      <div class="flex-1">
        ...
        <div class="mt-4">
          <h2 class="text-sm text-gray-400 font-bold mb-2">Account Informations</h2>

          <div class="grid grid-cols-2 gap-4">
            <div class="">
              <label for="name" class="text-sm text-gray-700 font-medium">Update Profile</label>
              <input type="file" id="name" name="name" class="text-sm border-2 border-gray-200 px-4 py-3 text-gray-700 rounded-lg w-full outline-none focus:border-primary">
            </div>
          </div>
        </div>
        ...
        <div class="flex justify-between">
          ...
          <button class="px-6 py-3 mt-4 text-white text-sm rounded-lg bg-primary font-medium hover:bg-blue-600">Update Profile</button>
