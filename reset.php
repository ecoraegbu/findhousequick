      ...
      <div class="w-full px-6 max-w-sm">
        ...
        <form action="" class="mt-10">
          <div class="relative bg-main flex items-center pl-2 rounded-lg">
            ...
            <input type="text" value="username@example.com" readonly placeholder="you@example.com" class="text-sm px-2 py-4 bg-main text-gray-700 rounded-lg w-full outline-none">
          </div>
          ...
          <div class="relative bg-main flex items-center pl-2 rounded-lg mt-3">
            ...
            <input type="text" placeholder="New Password" class="text-sm px-2 py-4 bg-main text-gray-700 rounded-lg w-full outline-none">
          </div>
          <!-- Error -->
          ...
          <div class="relative bg-main flex items-center pl-2 rounded-lg mt-3">
            ...
            <input type="text" placeholder="Comfirm New Password" class="text-sm px-2 py-4 bg-main text-gray-700 rounded-lg w-full outline-none">
          </div>
          <!-- Error -->
          <!-- <small class="text-red-500">Password field is required</small> -->
