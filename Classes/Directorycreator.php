...
class DirectoryCreator {
  ...
  public function __construct($baseDirectory = BASE_URL) {
    $this->baseDirectory = $baseDirectory;
  }

  public function createDirectory($userId, $username, $objectName) {
    ...
    $directoryPath = $this->baseDirectory . $directoryName;
